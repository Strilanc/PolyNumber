...
namespace Strilanc.PolyNumber.Internal {
    internal static class CollectionUtil {
        ...
        public static IEnumerable<KeyValuePair<TKey, TVal>> KeyReduce<TKey, TVal>(this IEnumerable<KeyValuePair<TKey, TVal>> sequence,
                                                                                  Func<TVal, TVal, TVal> duplicateKeyValueReducer) {
            if (sequence == null) throw new ArgumentNullException("sequence");
        ...
        public static IEnumerable<KeyValuePair<TKey, TVal>> SelectKeyValue<TItem, TKey, TVal>(this IEnumerable<TItem> sequence,
                                                                                              Func<TItem, TKey> keySelector,
                                                                                              Func<TItem, TVal> valueSelector) {
            if (sequence == null) throw new ArgumentNullException("sequence");
